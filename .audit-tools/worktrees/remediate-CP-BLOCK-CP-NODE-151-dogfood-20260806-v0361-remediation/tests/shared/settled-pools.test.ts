...
import { readSettledPools, addSettledPool, isPoolSettlingOutcome } from "../../src/shared/dispatch/settledPools.js";
...
test("isPoolSettlingOutcome: terminal exhaustion settles; sizing faults and transients never do", () => {
