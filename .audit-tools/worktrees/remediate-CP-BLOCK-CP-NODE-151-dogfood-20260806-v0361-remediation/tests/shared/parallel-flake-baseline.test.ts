...
type FakeLeaf = [name: string, state: TaskState | undefined];
...
function fakeFile(filepath: string, leaves: FakeLeaf[], fileState: TaskState = "pass") {
  return {
    filepath,
...
function wholeSuite(...files: ReturnType<typeof fakeFile>[]) {
