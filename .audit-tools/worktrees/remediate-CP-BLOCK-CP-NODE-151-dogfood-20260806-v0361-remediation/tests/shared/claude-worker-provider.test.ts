...
import {
  ...
  type ClaudeWorkerProviderOptions,
} from "../../src/shared/providers/claudeWorkerProvider.js";
import {
  createFreshSessionProvider,
  resolveFreshSessionProviderName,
  type FreshSessionProviderDeps,
} from "../../src/shared/providers/providerFactory.js";
import { sourceProviderConfig, withSourceConfig } from "../../src/shared/quota/apiPool.js";
import { commandExists } from "../../src/shared/providers/providerPathGuard.js";
import type {
  ClaudeWorkerConfig,
  DispatchableSource,
...
/** The stub `launchCommand`'s captured invocation — snapshot of what would have been spawned. */
interface CapturedLaunch {
  command: string;
  args: string[];
  input: LaunchFreshSessionInput;
  env: Record<string, string>;
  trustRaw: string | null;
}
...
function launchWorker(
  config: ClaudeWorkerConfig = WORKER_CONFIG,
