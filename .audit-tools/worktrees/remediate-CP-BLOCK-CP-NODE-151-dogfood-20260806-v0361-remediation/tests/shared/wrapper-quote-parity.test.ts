...
import { quoteForCmd as sharedQuoteForCmd } from "../../src/shared/tooling/exec.js";
import { quoteForCmd as wrapperQuoteForCmd, resolveSpawn } from "../../wrapper/audit-code-wrapper-lib.mjs";
...
const NASTY_ARGS = [
  ...CMD_METACHAR_CASES.map((c: { arg: string }) => c.arg),
  "plain",
