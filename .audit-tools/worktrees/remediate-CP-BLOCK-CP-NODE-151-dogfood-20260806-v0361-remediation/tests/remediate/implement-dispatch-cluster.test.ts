...
import { cleanupAndSetupRepo, cleanupTestDirOnly } from "../helpers/suiteLock.js";
...
beforeEach(async () => {
  await cleanupAndSetupRepo(TEST_DIR, REPO_DIR, ARTIFACTS_DIR, "cluster-test");
});

afterEach(async () => {
  await cleanupTestDirOnly(TEST_DIR);
});
