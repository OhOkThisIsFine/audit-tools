...
} from "../../src/shared/quota/scheduler.js";
import { renderDispatchDriverInstruction } from "../../src/shared/quota/dispatchDriverPrompt.js";
import { buildCacheablePrompt } from "../../src/shared/prompts.js";
import {
  filterNewProviders,
  advancePausedState,
} from "../../src/shared/rolling/pausedState.js";
import type { RollingEngineLifecycleState } from "../../src/shared/rolling/pausedState.js";
import { interpretIntent } from "../../src/shared/intent/clauseInterpreter.js";
import type { ClauseInterpretResult } from "../../src/shared/intent/clauseInterpreter.js";
...
test("emptied provider pool reaches waiting_for_provider terminal state", () => {
  ...
  const pausedState: Extract<RollingEngineLifecycleState, { kind: "waiting_for_provider" }> = {
...
test("per-clause escape-hatch: unencodable hard clause in otherwise-encodable compound intent", () => {
  ...
  let result!: ClauseInterpretResult;
