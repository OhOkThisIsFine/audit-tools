...
// Cluster edge builders: subsystem clustering, package-ownership clustering,
// module-ownership clustering, and entrypoint-flow bridge edges. All feed into
// buildPlanningGraphEdges, which is the single call site in reviewPackets.ts.
