...
// sources in src/contracts/workerSchemas.ts (or the base contracts they derive
// from) and rerun this. tests/worker-schema-generation.test.mjs fails if the
// committed files ever drift from what this script would write.
