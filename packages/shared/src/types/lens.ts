...
import { FindingSeveritySchema, FindingConfidenceSchema } from "./finding.js";

/** The canonical zod enum every other lens artifact derives from. */
...
/** The canonical ordered tuple of lenses. */
...
export const SEVERITIES: readonly FindingSeverity[] = FindingSeveritySchema.options;
...
export const CONFIDENCES: readonly FindingConfidence[] = FindingConfidenceSchema.options;
