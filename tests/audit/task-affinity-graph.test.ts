...
import type { TaskAffinityEdge, TaskAffinityGraph } from "../../src/audit/orchestrator/taskAffinityGraph.js";

const { buildTaskAffinityGraph, TaskAffinityGraphSchema } = await import("../../src/audit/orchestrator/taskAffinityGraph.js");
...
function edgeBetween(graph: TaskAffinityGraph, a: string, b: string): TaskAffinityEdge | undefined {
