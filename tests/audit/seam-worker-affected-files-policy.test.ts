...
const { validateAuditResults } = await import("../../src/audit/validation/auditResults.js");
...
function makeAuditTask(overrides: Partial<AuditTask> = {}): AuditTask {
  return {
...
function makeInScopeResult(overrides: Partial<AuditResult> = {}): AuditResult {
  return {
    task_id: "seam-task:correctness",
    unit_id: "seam-unit",
    pass_id: "pass:correctness",
...
function makeOutOfScopeResult(): AuditResult {
  return {
    task_id: "seam-task:correctness",
    unit_id: "seam-unit",
    pass_id: "pass:correctness",
