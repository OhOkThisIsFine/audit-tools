...
const { buildReviewPackets } = await import("../../src/audit/orchestrator/reviewPackets.js");
...
function makeTask(id: string, lines: number, overrides: Partial<AuditTask> = {}): AuditTask {
  return {
    task_id: id,
    unit_id: `unit-${id}`,
    pass_id: `pass:${id}`,
