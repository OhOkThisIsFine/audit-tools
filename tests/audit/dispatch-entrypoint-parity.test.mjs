/**
 * dispatch-entrypoint-parity.test.mjs
 *
...
async function writeSessionConfig(artifactsDir, config) {
  await writeFile(
...
function quotaArgv(artifactsDir, extra = []) {
  return [process.execPath, "cli.js", "quota", "--artifacts-dir", artifactsDir, ...extra];
}

function prepareDispatchArgv(artifactsDir, extra = []) {
  return [
    process.execPath,
    "cli.js",
    "prepare-dispatch",
