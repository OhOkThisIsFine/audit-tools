...
function narrative(order: "forward" | "reversed"): SynthesisNarrative {
  const themeA: FindingTheme = {
    theme_id: "T-auth",
...
test("OBL-C006: computeArtifactStateSignature is stable across non-semantic narrative variance", () => {
  ...
  const sigOf = (findings: AuditFindingsReport) =>
