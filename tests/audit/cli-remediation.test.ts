...
const { cliTestUtils, runCli } = await import("../../src/audit/cli.js");
const { runFirstAvailableCommand } = await import("../../src/audit/orchestrator/localCommands.js");

async function captureRunCli(argv: string[]) {
