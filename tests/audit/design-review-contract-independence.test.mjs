...
function endsWithPath(candidate, tail) {
 ...
 * conceptual flag.
 */
async function persistDesignReviewState(root, artifactsDir, { conceptualDone }) {
  const bundle = await buildAdvancedBundle(root, "design_review_contract_completed");
  if (conceptualDone) {
