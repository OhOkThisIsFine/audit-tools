...
import type { CoverageFileRecord } from "../../src/audit/types.js";
...
} = await import("../../src/audit/orchestrator/coverageElementBaseline.js");
...
function file(path: string, overrides: Partial<CoverageFileRecord> = {}): CoverageFileRecord {
  return {
    path,
    unit_ids: ["unit-1"],
