...
import type { HostFanoutUnit } from "../../src/audit/cli/dispatch/hostFanoutGate.js";
import type { AdmissionPool } from "../../src/shared/dispatch/admissionLoop.js";
...
const { gateHostFanout, reconcileHostFanoutLeases, hostFanoutQuotaPath } =
  await import("../../src/audit/cli/dispatch/hostFanoutGate.js");
const { admitBatch } = await import("../../src/shared/dispatch/admissionLoop.js");
const {
  ReservationLedger,
  getReservationLedgerPath,
} = await import("../../src/shared/quota/reservationLedger.js");
const { setQuotaStateDir, writeQuotaState } = await import(
  "../../src/shared/quota/state.js"
);
...
function units(n: number): HostFanoutUnit[] {
