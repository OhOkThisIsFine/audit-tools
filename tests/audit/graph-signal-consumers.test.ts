...
const { buildDesignAssessment } = await import(
  "../../src/audit/extractors/designAssessment.js"
);
...
function makeBundle(): GraphBundle {
  return {
    graphs: {
      imports: [
        { from: "a.ts", to: "b.ts" },
...
function makeUnitManifest() {
  return {
    units: [
      { unit_id: "u-a", name: "u-a", files: ["a.ts"], required_lenses: [] },
      { unit_id: "u-b", name: "u-b", files: ["b.ts"], required_lenses: [] },
      { unit_id: "u-c", name: "u-c", files: ["c.ts"], required_lenses: [] },
    ],
  };
}
...
test("appended detectors do not renumber existing DA-### ids", () => {
  ...
  const cyclicBundle: GraphBundle = {
    graphs: {
      imports: [
        { from: "a.ts", to: "b.ts" },
        { from: "b.ts", to: "a.ts" },
  ...
  const unitManifest = {
    units: [{ unit_id: "u-a", name: "u-a", files: ["a.ts", "b.ts"], required_lenses: [] }],
  };
  ...
  const register = buildRiskRegister(
    {
      units: [
        ...
        // family contributes.
        { unit_id: "u-hub", name: "u-hub", files: ["hub.ts"], required_lenses: [] },
      ],
    },
    undefined,
    undefined,
