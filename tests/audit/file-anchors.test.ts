  ...
  const externalAnalyzerResults: ExternalAnalyzerResults[] = [
    {
      tool: "test-analyzer",
      results: [
        { id: "rule-1", path: "src/counts.ts", category: "security", severity: "high", rule: "no-secret", summary: "secret found", line_start: 3 },
        { id: "rule-2", path: "src/other.ts", category: "style", severity: "low", rule: "no-var", summary: "use const", line_start: 1 },
      ],
    },
  ];
  ...
  const externalAnalyzerResults: ExternalAnalyzerResults[] = [
    {
      tool: "test-analyzer",
      results: [
        { id: "sig-1", path: "src\\Target.ts", category: "security", severity: "high", rule: "rule-a", summary: "match", line_start: 1 },
        { id: "sig-2", path: "src/unrelated.ts", category: "style", severity: "low", rule: "rule-b", summary: "no match", line_start: 1 },
      ],
    },
  ];
