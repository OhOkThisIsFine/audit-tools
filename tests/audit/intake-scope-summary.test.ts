...
const { detectMisScopeSmells, runIntakeExecutor } = await import("../../src/audit/orchestrator/intakeExecutors.js");
...
test("runIntakeExecutor includes a scope_summary in its result", async () => {
  ...
  const { isAuditExcludedStatus } = await import("../../src/audit/extractors/disposition.js");
