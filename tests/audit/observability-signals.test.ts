...
const { unionFindFromGroups } = await import("../../src/audit/orchestrator/reviewPacketGraph.js");
const { buildReviewPackets: buildReviewPacketsForObs } = await import("../../src/audit/orchestrator/reviewPackets.js");

function makeObsTask(
  task_id: string,
  unit_id: string,
  file_paths: string[],
  lens = "correctness",
