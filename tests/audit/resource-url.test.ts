...
const { resolveResourceUrl } = await import("../../src/audit/extractors/analyzers/resourceUrl.js");
const { graphLookupKey } = await import("../../src/audit/extractors/graphPathUtils.js");
