...
import { resolveModelStatics, resetModelStaticsCache } from "../../src/shared/quota/modelStatics.js";
import { resolveLimits } from "../../src/shared/quota/limits.js";
...
describe("resolveLimits static_metadata rung", () => {
  const baseConfig: SessionConfig = { quota: {} };
