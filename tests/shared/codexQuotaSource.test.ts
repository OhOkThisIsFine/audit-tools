...
import { CodexQuotaSource, mapCodexUsage, fetchCodexUsage } from "../../src/shared/quota/codexQuotaSource.js";
...
const validCreds = (): CodexAuthFixture => ({ auth_mode: "chatgpt", tokens: { access_token: "tok-c", account_id: "acct-1" } });
