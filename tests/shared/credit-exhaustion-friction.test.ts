...
import type { TriagedFrictionArtifact } from "../../src/shared/friction/frictionRecord.js";
 ...
 * tool tag, mirroring captureCostDriftFriction's pattern (tests/shared/cost-drift-friction.test.ts).
 */
