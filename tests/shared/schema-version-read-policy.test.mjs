...
} = await import("../../src/shared/io/schemaVersion.ts");

const { readTestPlanCarry, captureTestPlanCarry, testPlanCarryPath } =
  await import("../../src/remediate/contractPipeline/testPlanCarry.ts");
const { readReviewSnapshot, captureReviewSnapshot, reviewSnapshotPath } =
  await import("../../src/remediate/contractPipeline/reviewSnapshot.ts");
