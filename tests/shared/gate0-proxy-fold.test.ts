...
import type { AmbientSourceDeps } from "../../src/shared/providers/auditorSources.js";
import { ambientAuditorDescriptor } from "../../src/shared/types/auditorDescriptor.js";
import { gatherDispatchableSources } from "../../src/shared/quota/apiPool.js";
import { PROXY_CATALOG_VERSION } from "../../src/shared/providers/proxyCatalog.js";
import {
  deriveSourcePoolDisplayFromSources,
  annotateConfirmedPool,
} from "../../src/shared/providers/providerConfirmation.js";
import {
...
const EXPANDED: DispatchableSource[] = [
  {
...
function deps({ sources = EXPANDED }: { sources?: DispatchableSource[] } = {}): AmbientSourceDeps {
  return {
    env: {},
    homeDir: "/home/test",
    commandExists: () => false,
...
describe("reconciliation gate over the expanded lane (compare key + cap)", () => {
  const emptyConfirmation: SharedProviderConfirmation = {
