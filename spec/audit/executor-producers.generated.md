...
| `conceptual_review_adjudication.json` | design-review fold (src/audit/cli/nextStepHelpers.ts) | validated deep conceptual judge attribution is committed atomically with the conceptual findings it explains |
