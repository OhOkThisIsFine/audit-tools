...
2. Prompts 8 and 9 are owner-approved (2026-09-17) AND implemented, each with its pinning test
   ...
   silent.
3. Rows 8 through 19 are owner-approved (2026-09-17 and 2026-09-18) AND implemented. Row 20
   carries a lane-drafted PROPOSED spec below and awaits the owner's verdict. Prompt 20
