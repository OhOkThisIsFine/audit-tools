...
2. Prompts 8 and 9 are owner-approved (2026-09-17) AND implemented, each with its pinning test
   ...
   silent.
3. Rows 8 through 16 are owner-approved (2026-09-17 and 2026-09-18) AND implemented. Rows 17–20
   carry lane-drafted PROPOSED specs below and await the owner's verdict. Prompt 20
   (`src/remediate/steps/dispatch/hostHandoff.ts`) is loop-core, so it needs the design gate and a
   review attestation before it commits.
