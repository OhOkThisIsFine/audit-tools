...
| **excluded** | `docs/doc-review-guidelines.md` (this spec), `meta-audit-log.md` (append-only log — staleness review is a category error), `.audit-tools/remediation-report.md` (runtime run-artifact — a remediate-code run output, not a durable doc; tracked but never reviewed), `.audit-tools/audit-report.md` (same rationale — an audit-code run output, structurally parallel to its `remediation-report.md` sibling per `CLAUDE.md`'s Artifact layout; tracked but never reviewed), `docs/reviews/churn-context-enforce-pass-2026-06-27.md` (dated review-pass findings artifact — durable digest lives in `docs/backlog.md` #15; the tables are a one-off reference, not a timeless concept), `docs/reviews/churn-context-enforce-pass-2026-07-02.md` (dated review-pass findings artifact — the T5-run churn/context/enforce pass; actionable items N1/N4 live in `docs/backlog.md`, the record is a one-off reference, not a timeless concept), `docs/reviews/quota-prewall-pacing-diagnosis-2026-06-30.md` (dated root-cause diagnosis artifact — durable design lives in `spec/audit/dispatch-admission-control.md`; a one-off record of the pre-wall walling incident, not a timeless concept), `docs/reviews/host-self-quota-silently-disabled-2026-07-09.md` (dated root-cause diagnosis artifact — the record of why host self-quota monitoring kept silently disappearing; durable behavior now lives in the one-track collapse in `src/shared/quota/scheduler.ts` + `src/remediate/steps/dispatch/waveScheduling.ts` and the fail-loud in `src/remediate/steps/dispatch/marshal.ts`; a one-off record, not a timeless concept), `docs/reviews/dispatch-inventory-greenfield-design-2026-07-16.md` (dated design-synthesis artifact — the design-panel record behind the INTENT/CAPABILITY split; durable design lives in `spec/unified-dispatch-worker-model.md`, this is a one-off record, not a timeless concept), `docs/reviews/g1-auditor-descriptor-plan-2026-07-16.md` (dated plan artifact — the G1 `--auditor` descriptor collapse plan; durable design lives in `spec/unified-dispatch-worker-model.md`, a one-off record, not a timeless concept), `docs/reviews/g2-repo-session-intent-plan-2026-07-16.md` (dated plan artifact — the G2 `RepoSessionIntent` type-split plan; durable design lives in `spec/unified-dispatch-worker-model.md`, a one-off record, not a timeless concept), `docs/reviews/g2-5-source-emitter-plan-2026-07-16.md` (dated plan artifact — the G2.5 source-resolution plan plus the adversarial review that reworked it; durable design lives in `spec/unified-dispatch-worker-model.md`, a one-off record, not a timeless concept), `docs/reviews/g3-dispatch-policy-plan-2026-07-16.md` (dated plan artifact — the G3 policy-vs-reach plan and its four refuted drafts; durable design lives in `spec/unified-dispatch-worker-model.md`, a one-off record, not a timeless concept), `docs/reviews/g4-g5-g6-premise-check-2026-07-16.md` (dated premise-check artifact — the record of G4/G5/G6 being verified against HEAD before opening a lap, incl. two same-day self-corrections; the durable lessons live in `docs/backlog.md` + project memory, a one-off record, not a timeless concept), `docs/reviews/dispatch-fork-assessment-2026-07-16.md` (dated assessment artifact — the record of why dispatch had no auditor/remediator separation to begin with; durable design lives in `spec/unified-dispatch-worker-model.md` and the open remainder in `docs/backlog.md`, a one-off record, not a timeless concept), `docs/reviews/commit3-proxy-kind1-transport-plan-2026-07-16.md` (dated plan artifact — the commit-3 claude-worker launch-transport plan incl. its adversarial-review rewrite; durable design lives in `spec/unified-dispatch-worker-model.md`, a one-off record, not a timeless concept), `docs/reviews/claude-worker-lane-dogfood-2026-07-16.md` (dated dogfood-run findings artifact — the first live claude-worker lane run's evidence tables; actionable gaps live in `docs/backlog.md` → "claude-worker lane dogfood feedback gaps", a one-off record, not a timeless concept), `docs/reviews/claude-worker-feedback-gaps-plan-2026-07-17.md` (dated plan artifact — the gap-fix plan incl. verified ground truth + adversarial-review revisions; the accepted residuals live in `docs/backlog.md` → "claude-worker lane feedback-gap residuals", a one-off record, not a timeless concept), `docs/reviews/repair-proxy-dispatch-diagnosis-2026-07-17.md` (dated root-cause diagnosis artifact — the record of why the claude-worker/repair-proxy lane dispatched zero (the 750ms liveness-probe cold-drop) and how it was fixed both sides; durable fix lives in `src/shared/providers/auditorSources.ts` + repair-proxy `catalog.ts` and project memory [[repair-proxy-dispatch-unblocked-probe-fix]], a one-off record, not a timeless concept), `docs/reviews/host-fanout-proxy-dispatch-design-2026-07-17.md` (dated design-assessment artifact — the pool≠transport model + host fan-out design for proxied dispatch; durable design lives in `spec/unified-dispatch-worker-model.md` and project memory, a one-off record, not a timeless concept), `docs/reviews/host-fanout-premise-refuted-2026-07-17.md` (dated premise-refutation artifact — the record of the proxy_transport trigger premise collapsing against the run's own artifacts (pools WERE folded in; null context caps + collective settle were the real chain); durable direction lives in `docs/reviews/unified-dispatch-routing-design-2026-07-17.md` and project memory, a one-off record, not a timeless concept), `docs/reviews/unified-dispatch-routing-design-2026-07-17.md` (dated design+build record — the unified ONE-routing-decision design, owner decisions, per-step review findings and the H2+H4 remainder; the durable concept belongs to `spec/dispatch-jit-claims.md` + project memory once the collapse completes, a one-off record, not a timeless concept), `docs/reviews/h2-h4-collapse-plan-2026-07-18.md` (dated plan artifact — the H2+H4 branch-pair-collapse/demote-retirement plan with its four review records, blessed semantics and deliberate routing changes; durable direction lives in project memory [[unified-dispatch-routing-direction]] and residual pins in `docs/backlog.md`, a one-off record, not a timeless concept), `docs/reviews/litellm-swap-plan-2026-07-18.md` (dated plan artifact — the proxy-transport swap plan retiring repair-proxy and adopting LiteLLM as the generic proxy contract; durable direction lives in project memory [[litellm-replaces-repair-proxy]] and backlog entry "LiteLLM replaces repair-proxy" (docs/backlog.md:52), a one-off record, not a timeless concept), `docs/reviews/litellm-proxy-live-validation-2026-07-18.md` (dated live-validation findings artifact — the record of the v0.33.7 proxy-contract swap being exercised against a live LiteLLM proxy for the first time, incl. the per-deliverable result table and the `api_key_env` reach-verification defect it surfaced; the durable fix lives in `src/shared/providers/auditorSources.ts` + its `tests/shared/proxy-lane.test.mjs` pins, remaining work in `docs/backlog.md` → Track 1 and the traps in → Durable traps, a one-off record, not a timeless concept), `docs/model-capability-ranking-sources.md` (dated market-survey artifact — the 2026-07-18 survey of someone-else-maintained capability/agentic ranking sources, run because retiring repair-proxy removed the only automated capability signal; the durable outcome is the consumption-pattern decision (runtime-fetch vs vendored) which belongs in the ranker-contract track in `docs/backlog.md` + project memory once chosen, a one-off record whose numbers go stale by design, not a timeless concept), `docs/reviews/capability-evidence-obligation-plan-2026-07-18.md` (dated plan artifact — the plan for converting the admission capability fail-open into a pin-it-down obligation, incl. the adversarial review that refuted three v1 claims and moved the edit layer; durable direction lives in `docs/backlog.md` + project memory, a one-off record, not a timeless concept), `docs/reviews/capability-evidence-implementation-review-2026-07-18.md` (dated implementation-review artifact — the per-round record of three adversarial review rounds against the capability-evidence obligation, what each refused and which owner decisions settled it; the durable direction lives in `docs/backlog.md` + project memory [[capability-evidence-is-an-obligation]], a one-off record, not a timeless concept), `docs/reviews/nim-dispatch-single-pool-2026-07-19.md` (dated defect-and-repair record — the N-models-on-one-credential metering defect, its round-1 refusal and round-2 rework; superseded as a repair direction by the design-of-record below, kept for the two "how the green tree lied" verification lessons which live durably in `docs/backlog.md` + project memory, a one-off record, not a timeless concept), `docs/reviews/account-metering-round2-independent-review-2026-07-19.md` (dated independent-review artifact — the 3-of-3 unanimous refusal of the round-2 account-metering rework, incl. the executed starvation scenario and the correction that a unanimous refusal can still carry a wrong remedy; durable lessons live in project memory [[account-scoped-metering-refused-then-reworked]], a one-off record, not a timeless concept), `docs/reviews/account-metering-design-of-record-2026-07-19.md` (dated design-of-record — the window-scoped metering partition that resolved four rounds of refused repairs, plus the step-1..4 breakdown and its residuals; **currently load-bearing** as the plan steps 2–4 execute, and belongs in `spec/` as a timeless concept once they land — dated-record status is deliberate until then), `docs/reviews/memory-consolidation-2026-07-19.md` (dated consolidation-pass record — the 149→136 memory-store pass, its verification evidence and the rejected offload-lane verdicts; the durable lesson lives in project memory [[refactor-must-sweep-memory-not-just-code]] and the actionable items in `docs/backlog.md`, a one-off record, not a timeless concept), `docs/reviews/identity-migration-stage1-plan-2026-07-19.md` (dated plan artifact — the stage-1 classification for the backend-identity migration: the chokepoint trace, the `dispatchableSourceId` normalization hazard, the correction that the transport-keyed price lookup is inert at HEAD, and the two offloaded claims re-verified against source; durable design lives in `spec/backend-identity-axes.md` and the staged plan in `docs/backlog.md` → Forward tracks, a one-off record, not a timeless concept), `docs/reviews/capacity-guard-2026-07-20.md` (dated design+build record — the stage-4 capacity-guard prerequisite: why a rules-zeroed dispatch capacity was silent, the discrimination that separates it from a legitimately unconfigured run, and the one adversarial finding that was red-green falsified and reverted; durable design lives in `spec/backend-identity-axes.md` + the stage-4 entry in `docs/backlog.md` → Forward tracks and project memory [[capacity-guard-shipped-stage4-unblocked]], a one-off record, not a timeless concept), `docs/reviews/capability-evidence-salvage-2026-07-20.md` (dated salvage record — why the review-blocked `wip/capability-evidence` branch could not merge, which of its two bundled workstreams was kept, and the landing gate for the capability-evidence obligation; **currently load-bearing** while that gate is unsettled — see `docs/backlog.md` → R3-3 — and belongs in project memory [[capability-evidence-is-an-obligation]] once it closes, a one-off record, not a timeless concept), `docs/reviews/antigravity-agent-commits-2026-07-21.md` (dated review record — the check of the five Antigravity agent commits of 2026-07-20 night: the self-issued loop-core attestations, the false green attestation over a tree that could not parse, the landing gate rewritten UNMET→MET, and the two commits that were genuine; the durable lesson (a gate cannot tell reviewer from author) lives in `docs/backlog.md` → Open bugs and project memory [[loop-core-enforcement-layer]], a one-off record, not a timeless concept), `docs/reviews/re-dogfood-2026-07-21.md` (dated live-validation run record — the v0.34.6 re-dogfood self-audit's 15 numbered observations (two HIGH ingest defects, the 429 wall sequence, zero-spill lead, D-66/67 claim-bite evidence) plus the paused run's resume state; actionable items live in `docs/backlog.md` → Open bugs, a one-off record, not a timeless concept), `docs/reviews/re-dogfood-friction-2026-07-22.md` (dated friction ledger — the completed re-dogfood run's 11 mechanism-grade friction/defect entries; actionable items live in `docs/backlog.md`, a one-off record, not a timeless concept), `docs/reviews/re-dogfood-endgame-2026-07-22.md` (dated completion-blocker forensics — the same run's endgame log of what blocked present_report; actionable items live in `docs/backlog.md`, a one-off record, not a timeless concept), `docs/reviews/remediate-dogfood-2026-07-22.md` (dated dogfood-run record — the first full remediate-code contract-pipeline run on real audit findings: convergence history, the implement-wave wall with its diagnosed defect cluster, and the resume protocol; actionable items live in `docs/backlog.md` → the never-dispatched entry, a one-off record, not a timeless concept), `docs/reviews/implement-dispatch-cluster-mechanisms-2026-07-22.md` (dated recon/mechanism record — the source+artifact-verified mechanisms of the four implement-dispatch defects (handshake seam drop, empty-frontier conflation, refusal-blind dispositions, single-finding split atomicity) behind the v0.34.12 fix cluster; durable behavior lives in the shipped code + its `tests/remediate/implement-dispatch-cluster.test.ts` pins and the shipped entry in `docs/backlog.md`, a one-off record, not a timeless concept), `docs/reviews/remediate-dogfood-completion-2026-07-23.md` (dated run-completion record — the resumed dogfood's 8/8-resolved finish, the five new defects the resume surfaced (two shipped as v0.34.14/15, three specced), the driver recovery protocols, and the accreted worker-prompt rules; actionable items live in `docs/backlog.md`, a one-off record, not a timeless concept), `docs/reviews/accept-latch-family-mechanisms-2026-07-23.md` (dated recon/mechanism record — the three-trace source-verified mechanisms of the accept-latch family behind the 2026-07-23 fix: the unconditional accepted-latch, the REFUTED session-base rollback, the pre-gate worktree removal, and the no-change closures that skipped the ancestry reconcile; durable behavior lives in the shipped code + its `tests/remediate/host-rolling-dispatch.test.ts` / `dispatch-worktree-safety.test.ts` pins and the shipped entry in `docs/backlog.md`, a one-off record, not a timeless concept), `docs/reviews/node-worktree-guard-mechanisms-2026-07-23.md` (dated recon/mechanism record — the node-context clobber tier behind the 2026-07-23 fix: the climb-redirect clobber mechanism, the wrapper cwd-pinning complication, the driver-only-vs-worker-safe axis, and the refuted owner-token / env-redirect / build-first alternatives; durable behavior lives in the shipped code + its `tests/shared/node-worktree-guard.test.mjs` pins and the shipped entry in `docs/backlog.md`, a one-off record, not a timeless concept), `docs/reviews/zero-spill-capability-floor-2026-07-23.md` (dated recon/mechanism record — the zero-spill wave defect behind the 2026-07-23 fix: the build-time `bestAvailableBand` snapshot that stranded ~140 packets with healthy confirmed siblings never attempted, the availability-aware floor that replaces it, and the paused-pool wait-tick residual; durable behavior lives in the shipped code + its `tests/shared/rollingDispatch.test.mjs` / `admission-loop.test.mjs` pins and the backlog LEAD for the residual, a one-off record, not a timeless concept), `docs/reviews/intent-gate-charter-slice-design-2026-07-23.md` (dated design+build+review record — the DD-9 intent-equivalence gate + charter dependency-slice layer behind the 2026-07-23 fix: verified premises, the v1→v2 design turn (AGY's baseline-self-overwrite finding + effective-hash commit), the four-lane independent-review record and the applied blockers F1–F4; durable behavior lives in the shipped code + its `tests/audit/intent-equivalence-executor.test.mjs` / `dependency-slices.test.mjs` / `intent-checkpoint-gate.test.mjs` pins and the residuals entry in `docs/backlog.md`, a one-off record, not a timeless concept), `docs/reviews/dispatch-legibility-trace-2026-07-23.md` (dated mechanism+review record — the dispatch-legibility trace behind the 2026-07-23 fix: full constraint-outcome explain records, the `planned` explains closing the 144-granted-empty-explains path, the engine decision log with per-pool strand why-nots, and the four-lane adversarial-review history incl. the host reviewer's four adopted findings; durable behavior lives in the shipped code + its `tests/shared/admission-loop.test.mjs` / `rollingDispatch.test.mjs` / `dispatch-decision-log.test.mjs` pins and `spec/audit/dispatch-admission-control.md` → Resolved decision 3, a one-off record, not a timeless concept), `docs/reviews/worker-kind-pool-class-rule-2026-07-23.md` (dated mechanism+review record — the worker-kind × pool-class compatibility rule behind the 2026-07-23 fix: the declared `burst_limited` pool-class, the one-predicate two-boundary enforcement, the override-proof `deriveWorkerKind` contract correction the AGY review forced, and the NIM/AGY adversarial-review history with Codex quota-walled; durable behavior lives in the shipped code + its `tests/shared/auditor-sources.test.mjs` / `proxy-lane.test.mjs` / `dispatchable-sources.test.mjs` / `claude-worker-source.test.mjs` pins and the populate-conversion LEAD in `docs/backlog.md`, a one-off record, not a timeless concept), `docs/reviews/litellm-vs-cli-dispatch-investigation-2026-07-23.md` (dated investigation artifact — why LiteLLM fronts models while CLI agents are harnesses that can't be proxied mid-loop, and how 9router relates; the durable answer lives in `docs/reviews/host-routed-dispatch-design-2026-07-23.md` + project memory [[litellm-replaces-repair-proxy]], a one-off record, not a timeless concept), `docs/reviews/proactive-dispatch-via-9router-2026-07-23.md` (dated design-note artifact — the "name the target / combo vocabulary" reasoning, since sharpened by the dynamic-router correction in the design-of-record below; durable direction lives in `docs/reviews/host-routed-dispatch-design-2026-07-23.md` + project memory [[routing-is-separate-from-categorization]], a one-off record, not a timeless concept), `docs/reviews/host-routed-dispatch-design-2026-07-23.md` (dated design+build record — the 9router-backed routing architecture (audit-code categorizes / a re-pointed deterministic router routes / 9router transports) and its right-sized build plan; **currently load-bearing** while the integration is unbuilt, and belongs in `spec/` as a timeless concept once it lands — dated-record status deliberate until then), `docs/reviews/9router-routing-sprint-handoff-2026-07-23.md` (dated sprint-handoff artifact — the pickup state for the 9router integration sprint (deploy done, Claude-Code wiring + routing build pending); durable design lives in the design-of-record above and project memory, a one-off record, not a timeless concept), `docs/reviews/abnormal-exit-blocked-step-backstop-2026-07-23.md` (dated mechanism+review record — the terminal-exit blocked-step backstop behind the 2026-07-23 fix: the shared backstop semantics + blocked-step assembly, both orchestrator draws, the red-green mutation check, and the NIM/AGY adversarial-review history with the accepted pre-backstop-bypass catch and Codex quota-walled; durable behavior lives in the shipped code + its `tests/shared/blocked-step-backstop.test.mjs` / `tests/audit/next-step.test.mjs` / `tests/remediate/next-step-blocked-backstop.test.ts` pins, a one-off record, not a timeless concept), `docs/reviews/pause-wall-per-packet-strand-2026-07-23.md` (dated mechanism+review record — the per-packet pause wall behind the 2026-07-23 fix: the `packetPoolBlockReason` single-sourced refusal disjunction, the retryable `quota_paused` strand replacing the 50ms wait-tick spin on a paused best pool, the wall-time reset capture closing the `getTerminal` pause-expiry race, the reentrancy strand-then-emit ordering, and the codex/AGY/NIM adversarial-review history incl. the caller-transport `UND_ERR_HEADERS_TIMEOUT` diagnosis; durable behavior lives in the shipped code + its `tests/shared/rollingDispatch.test.mjs` pins and the `window_uncalibrated` LEAD in `docs/backlog.md`, a one-off record, not a timeless concept), `docs/reviews/backlog-clearance-2026-07-24.md` (dated clearance-lap record — which backlog entries were verified closable and by what evidence, plus the mechanisms confirmed at HEAD; the surviving work lives in `docs/backlog/open-bugs.md` and the shipped behaviour in its tests, so this is a one-off record, not a timeless concept), `docs/reviews/backlog-clearance-2026-07-24b.md` (dated clearance-lap record — the second 2026-07-24 lap: the stray-worktree terminal-class fix, and the three-attempt record of the per-node token estimate that was built, verified and reverted because an honest estimate makes an unplaceable node reachable while both consumers handle that terminally; the surviving work lives in `docs/backlog/open-bugs.md` and the shipped behaviour in its tests, a one-off record, not a timeless concept), `tests/audit/fixtures/simple-app/README.md` (test-fixture content — a sample-app README, its own concern, not a project doc) | — | — |
...
| **meta-tooling / dev-workflow** | `.claude/skills/disambiguate-backlog/SKILL.md`, `.claude/skills/ship/SKILL.md`, `.claude/skills/start-lap/SKILL.md`, `docs/nightly-routine.md`, `docs/nightly-routine-prompt.md` | Standalone dev-workflow how-to (no generated-asset relationship); do the documented commands/paths still resolve. `nightly-routine-prompt.md` is THIS routine's own scheduler prompt: check its commands/paths/ports resolve (codex invocation, proxy endpoint, memory-store path) — but it is an operational summary of `nightly-routine.md` + this spec, so any CONFLICT is resolved in those files' favor and reported as a finding, never by editing them to match the prompt. | factual-stale → yes |
