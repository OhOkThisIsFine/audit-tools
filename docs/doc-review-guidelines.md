...
| **meta-tooling / dev-workflow** | `.claude/skills/disambiguate-backlog/SKILL.md`, `.claude/skills/ship/SKILL.md` | Standalone dev-workflow how-to (no generated-asset relationship); do the documented commands/paths still resolve. | factual-stale → yes |
