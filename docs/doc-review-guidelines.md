...
| **meta-tooling / dev-workflow** | `.claude/skills/design-check/SKILL.md`, `.claude/skills/disambiguate-backlog/SKILL.md`, `.claude/skills/ship/SKILL.md`, `docs/nightly-routine.md` | Standalone dev-workflow how-to; do the documented commands/paths still resolve. | factual-stale → yes |
