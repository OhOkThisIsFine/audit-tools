...
- `open-bugs.md:9` — The session-start offload-trust guard suppresses a WORKING lane on a premise that measurement refutes (2026-08-29, high, friction: false_red).
