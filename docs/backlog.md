...
- `open-bugs.md:517` — Friction walk (copy-fallback lap, 2026-08-30):
- `open-bugs.md:544` — Friction walk (commitFold unlink lap, 2026-08-30):
- `open-bugs.md:567` — Friction walk (guard-test-hermeticity lap, 2026-08-30):
- `open-bugs.md:585` — Friction walk (two-identities lap, 2026-08-30):
- `open-bugs.md:602` — Friction walk (determinations-execution lap, 2026-07-29):
- `open-bugs.md:616` — Friction walk (duplicated-guard lap, 2026-07-25):
- `open-bugs.md:628` — The per-result LLM conformance review — the opt-in depth dial half of the owner decision — is unbuilt, so semantic conformance to the carried module contracts is still judged by nothing (2026-08-09, narrowed 2026-08-29, medium).
- `open-bugs.md:639` — Self-audit dogfood loop: fixing the tool mid-run invalidates the run (2026-07-16, ambiguous-direction, low-medium).
- `open-bugs.md:655` — Friction walk (niggle-fix lap, 2026-08-07):
- `open-bugs.md:673` — Friction walk (loop-core `.ts`-conversion tranche lap, 2026-07-28):
- `open-bugs.md:685` — Friction walk (nightly-determinations lap, 2026-07-26):
- `open-bugs.md:697` — Friction walk (touched_files load-gate lap, 2026-07-25):
- `open-bugs.md:703` — Friction walk (fourth backlog-clearance lap, 2026-07-24):
- `open-bugs.md:716` — Friction walk (second backlog-clearance lap, 2026-07-24):
- `open-bugs.md:725` — Untracked-exclusion scope rule — residuals only (each low-severity, documented at the code site).
...
- `open-bugs.md:807` — Steward verification metadata is undeliverable through the host-result envelope (hit 2026-08-18).
- `open-bugs.md:817` — The report renderer emits control characters from finding prose raw (hit 2026-08-18).
- `open-bugs.md:824` — A killed `next-step` wedges `phase.lock` for every later call (2026-08-24, remediation run, medium).
- `open-bugs.md:833` — A provenance plane with no producer is still exported, advertised and documented (2026-08-27, from the philosophy audit, medium).
- `open-bugs.md:835` — Three persisted contracts are read back without the schema that defines them (2026-08-27, from the philosophy audit, medium).
- `open-bugs.md:837` — The pre-split design-review lane is still polled beside the two current judgment types (2026-08-27, from the philosophy audit, medium).
- `open-bugs.md:839` — The N-R13 status invariant asserts its own literal, and the status vocabulary exists in three unlinked copies (2026-08-27, low-medium).
- `open-bugs.md:855` — The dispatch boundary strips every per-node field the contract pipeline writes onto a promoted finding but `FindingSchema` does not declare (2026-08-27, medium).
- `open-bugs.md:875` — The two evidence-bearing terminal dispositions have no producer — `verified_already_fixed` and `refuted` are unreachable in any real run (2026-08-27, medium, from [`reviews/wave2-dispositions-2026-08-20.md`](./reviews/wave2-dispositions-2026-08-20.md)).
- `open-bugs.md:900` — The closeout render record cannot name the session that wrote it, on a premise that is false (2026-08-27, medium, from [../reviews/closeout-generation-failure-2026-08-26.md](./reviews/closeout-generation-failure-2026-08-26.md)).
- `open-bugs.md:902` — An analysis record can identify work and reach no work queue, and every gate stays green while it happens (2026-08-27, medium, from the orphan-routing lap).
- `open-bugs.md:923` — The masked-exit guard keyed on TEST RUNNERS, not on whether the exit status is load-bearing — NARROWED to its curated-list half (2026-08-27, narrowed 2026-08-29, medium, friction: tool_should_decide).
