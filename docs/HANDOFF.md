...
- **Immediate next: none forced — dispatch rework is done.** Pick the next T5 item (deterministic-analyzer
  live spawn, or CE-004 NIM guided-decoding). **Residual on dispatch (env-bound / deeper, in `docs/backlog.md`):**
