...
export const RUNTIME_NAME_SOURCES = [
  ...
  { file: "src/audit/io/runArtifacts.ts", rules: ["joinLiterals", "filenameConstants"] },
  { file: "src/audit/cli/dispatch/hostHandoff.ts", rules: ["joinLiterals"] },
  { file: "src/audit/cli/laneSubmissions.ts", rules: ["filenameConstants"] },
  { file: "src/audit/orchestrator/charterPacketArchive.ts", rules: ["joinLiterals"] },
