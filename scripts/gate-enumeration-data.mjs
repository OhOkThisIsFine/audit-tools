...
export const STEP_GLOSS = {
  ...
  "check:generated-artifacts": "generated-artifact freshness-authority reconciliation",
  "check:invariant-glossary": "production invariant-namespace glossary completeness",
  "check:nightly-inbox": "nightly inbox projection parity",
